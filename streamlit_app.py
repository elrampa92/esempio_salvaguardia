...
with col1:
    ...
    st.write(f"Percentuale: {percentuale_disponibile:.2f}%")

# Colonna destra: grafico a torta
with col2:
    # Creazione del grafico a torta
    fig1, ax1 = plt.subplots()
    ax1.pie([quota_disponibile, spesa], labels=["Disponibile", "Spesa"], colors=["blue", "orange"], autopct="%1.1f%%", startangle=90)
